...
-- -----------------------------------------------------
-- Table `bowling`.`averages`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bowling`.`averages` ;

CREATE TABLE IF NOT EXISTS `bowling`.`averages` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `userId` BIGINT NOT NULL,
  `latestAverage` INT NOT NULL,
  `totalAverage` INT NOT NULL,
  `createdAt` DATETIME NOT NULL,
  `updatedAt` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `idx_userId` (`userId` ASC))
